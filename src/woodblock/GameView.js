        ...
        .start()
          ...
          .start()
            ...
            .start('button')
              ...
              .attrs({ type: 'button', title: 'Decrease board width' })
            ...
            .start('button')
              .addClass(this.myClass('step'))
              .attrs({ type: 'button', title: 'Increase board width' })
          ...
          .start()
            ...
            .start('button')
              .addClass(this.myClass('step'))
              .attrs({ type: 'button', title: 'Decrease board height' })
            ...
            .start('button')
              .addClass(this.myClass('step'))
              .attrs({ type: 'button', title: 'Increase board height' })
